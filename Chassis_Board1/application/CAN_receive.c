...
//解码板件通讯数据
void get_board_measure(uint8_t data[8])
{
    get_board_data.ch_0 =  (int16_t)(data[0] << 8 | data[1]);
    get_board_data.ch_1 = (int16_t)(data[2] << 8 | data[3]);
    get_board_data.s_1 = data[4];
    get_board_data.s_0 = data[5];
}
